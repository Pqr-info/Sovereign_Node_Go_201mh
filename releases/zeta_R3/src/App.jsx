...
import ChatGeminiClient from './components/ChatGeminiClient';
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        ...
        <nav style={{ width: '80px', borderRight: '1px solid var(--border)', display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '1rem 0', gap: '1rem', background: 'var(--bg-1)', zIndex: 50 }}>
          ...
          <button 
            ...
            style={{ background: 'transparent', border: 'none', color: activeTab === 'recovery' ? 'var(--color-blue)' : 'var(--text-secondary)', cursor: 'pointer', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px' }}
          >
            <Activity size={24} />
            <span style={{ fontSize: '10px' }}>Recovery</span>
          </button>
          ...
          <div style={{ marginTop: 'auto', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.5rem' }}>
            ...
            <button 
              onClick={() => setActiveTab('chat-gemini')}
              style={{ background: 'transparent', border: 'none', color: activeTab === 'chat-gemini' ? 'var(--color-blue)' : 'var(--text-secondary)', cursor: 'pointer', padding: '0.5rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px' }}
            >
              <Terminal size={20} />
        ...
        <main style={{ flex: 1, position: 'relative', overflowY: 'auto', overflowX: 'hidden', height: '100%' }}>
          ...
          {activeTab === 'chat-gemini' && <ChatGeminiClient />}

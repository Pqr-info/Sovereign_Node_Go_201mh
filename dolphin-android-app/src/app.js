...
import { renderStadiumView } from './components/Stadium.js';
import { renderWikiView } from './components/Wiki.js';
...
class DolphinAppController {
  ...
  renderActiveTabContent(config) {
    ...
    switch (this.activeTab) {
      ...
      case 'stadium':
        setTimeout(() => window.fetchStadiumFeed && window.fetchStadiumFeed(), 50);
        return renderStadiumView();

      case 'wiki':
        return renderWikiView();

# SWEND Swarm Starter Script
$projectDir = "C:\Users\drphi\pqr-info-swarm"

if (Test-Path $projectDir) {
    Set-Location $projectDir
    Write-Host "Initializing SWEND Swarm Stack..." -ForegroundColor Cyan
    ...
    if ($LASTEXITCODE -eq 0) {
        Write-Host "SWEND Sovereign Cluster is ONLINE at pqr.info" -ForegroundColor Green

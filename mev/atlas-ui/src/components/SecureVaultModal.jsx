...
export default function SecureVaultModal({ isOpen, onClose, onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!totpPin || totpPin.length !== 6) {
      setStatus({ ok: false, msg: 'Valid 6-digit TOTP PIN is required.' });
      return;
    }
    ...
    <div style={{
      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit}>
          ...
          {/* TOTP PIN Input */}
          <div style={{ marginBottom: '1rem' }}>
            <label style={{ display: 'block', fontSize: '0.75rem', color: '#f59e0b', marginBottom: '0.3rem', textTransform: 'uppercase', letterSpacing: '1px' }}>
            ...
            <input
              ...
              placeholder="123456"
              value={totpPin}
              onChange={(e) => setTotpPin(e.target.value.replace(/\D/g, '').slice(0, 6))}
              style={{
                width: '100%',
                padding: '0.6rem',
                background: '#020617',
